<script lang="ts">
	...
	import { playHover, playLock, playThreat } from '../audio';
	import { isValidMove } from '../engine';
	import { computeLayout, columnLeft, discX, discY, holeCenter } from '../layout';
	import type { GameSession } from '../session.svelte';
	import { lookSettings } from '../settings.svelte';
